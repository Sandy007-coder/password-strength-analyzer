...
const CLEAR_CONFIRMATION_TIMEOUT_MS = 4000
    ...
    >
      <div className="flex flex-wrap items-center justify-between gap-2">
        <span
          ...
          style={{
            ...
            background: `${strengthStyle.color}18`,
            border: `1px solid ${strengthStyle.color}44`,
            textShadow: `0 0 8px ${strengthStyle.color}`,
          }}
        >
      ...
      <div className="space-y-1">
        <div className="str-track h-1.5 w-full overflow-hidden rounded-sm">
          <div
            ...
            style={{
              ...
              background: `linear-gradient(90deg,${strengthStyle.color}88,${strengthStyle.color})`,
              boxShadow: `0 0 6px ${strengthStyle.color}`,
            }}
          />
        </div>
        ...
        >
          <span>
            SCORE:{' '}
            <span style={{ color: strengthStyle.color }}>
              {record.score}/10
            </span>
          </span>
    ...
    <div className="glass rounded-lg p-4 space-y-4">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div className="flex items-center gap-2">
          ...
          {!isLoading && (
            <span
              className="rounded-sm border border-cyan/20 bg-cyan/10 px-2 py-0.5 font-mono text-xs text-cyan"
            >
              {historyCount}
            </span>
          )}
        ...
        <div className="flex gap-2">
          ...
          {hasHistory && (
            <button
              ...
              className={`
                btn-danger flex items-center gap-1.5
                rounded px-3 py-1.5 text-xs
                ${
                  isAwaitingConfirmation
                    ? 'bg-red-neo/20 border-red-neo/60 shadow-neon-red'
                    : ''
                }
              `}
            >
